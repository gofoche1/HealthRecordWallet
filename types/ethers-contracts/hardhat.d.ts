...
getContractFactory(name: 'HealthWalletConsent', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.HealthWalletConsent__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'HealthWalletConsent', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.HealthWalletConsent>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'HealthWalletConsent', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.HealthWalletConsent>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'HealthWalletConsent', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.HealthWalletConsent>
